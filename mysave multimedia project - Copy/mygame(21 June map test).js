...
scene("mygame",  ({ level, score }) =>{
	...
	layer(['bg', 'obj', 'ui'], 'bg')
 	...
 	const maps = [
        ...
        [   
	        ...
	        'a a       a  c  a  a   a',
	        'a aaaaaaa a a a   aa = a',
	        'a a       aaa aaaaaaaaaa',
	        'aaaa aaaaaa a     c  aaa',
	        'a           aaaaaaaa  aa',                  
	        'a aaaaaaaaaaa       a aa',                                                       /////  LEVEL 5  /////
	        'a a          aaaaa a   a',                  
	...
	const levelCfg = {
		...
		'z': [sprite('myhouse'), scale(0.5), solid(), 'walls'],
		...
		'1': () => [sprite('bg1'), scale(0.957),],  //music.play("theme5", {volume: 0.5})    //play(music[1])
		'2': () => [sprite('bg2'), scale(2), layer('bg'),],  //music.play([2])
		'3': () => [sprite('bg3'), scale(2), layer('bg'),],  //play(music[2])
