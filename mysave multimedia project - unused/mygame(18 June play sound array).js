...
scene("mygame",  ({ level, score }) =>{
 ...
 //        [("theme5", {volume: 0.5})],
 //        [("theme3", {volume: 0.5})],  //("theme3", {volume: 0.5})
 //    ]
	...
	const levelCfg = {
		...
		'?': () => [sprite('bg1'), scale(0.957), play(music[2])],  //music.play("theme5", {volume: 0.5})    //play(music[1])
		'+': () => [sprite('bg2'), scale(2), layer('bg'), play(music[1])],  //music.play([2])
		'x': () => [sprite('bg3'), scale(2), layer('bg'), play(music[3])],  //play(music[2])
