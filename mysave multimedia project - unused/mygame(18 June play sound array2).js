...
scene("mygame",  ({ level, score }) =>{
 ...
 //    ]
	...
	const levelCfg = {
		...
		'?': () => [sprite('bg1'), scale(0.957), play(music[3])],  //music.play("theme5", {volume: 0.5})    //play(music[1])
		'+': () => [sprite('bg2'), scale(2), layer('bg'), play(music[1])],  //music.play([2])
		'x': () => [sprite('bg3'), scale(2), layer('bg'), play(music[2])],  //play(music[2])
